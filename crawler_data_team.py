...
#
csv_file = os.path.join(csv_dir, "teams_played_in_season_2023.24.csv")
...
with open(csv_file, "w", newline="") as file:
    ...
    table_div = soup_match_page_when_selecting_season.find("table", class_="leagueTable table-sort premier-league England")
    for each_team in table_div.find_all("tr", class_="leagueTeam"):
        name_team = each_team.find("td", class_="leagueTableTeamName").find("div").text.strip()
        writer.writerow([name_team])